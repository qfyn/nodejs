...
// const url = 'H:/资料/云侧开发/2024/国网安徽/04.【软需】新技术及应用-2023年电力北斗系统服务能力提升--设计开发实施项目-软件需求规格说明书.docx'
// // 读取Word文档并保存为html
// mammoth.convertToHtml({ path: url }).then(res => {
//   fs.writeFileSync('output.html', res.value);
// })


// 删除img标签
// const file = fs.readFileSync('./output.html')
// const filteString = file.toString().replace(/<img([\s\S]*?) \/>/g, '')
// fs.writeFileSync('filteString.html', filteString);
